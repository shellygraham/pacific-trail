            ...
            plugins: {
                ...
                files: {
                    'assets/js/plugins.min.js': [
                        ...
                        'assets/bower_components/owlcarousel/owl-carousel/owl.carousel.min.js',
                        'assets/bower_components/jQuery.mmenu/dist/core/js/jquery.mmenu.min.js'
                    ]
                }
            },
            main: {
                ...
                files: {
                    'assets/js/main.min.js': [
                        ...
                        'assets/js/source/carousels.js',
                        'assets/js/source/product-categories.js',
                        'assets/js/source/single-product.js'
                    ],
